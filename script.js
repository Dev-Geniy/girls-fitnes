...
const adviceList = [
    "Вы сегодня выполнили все упражнения, приходите завтра! Пейте 2-3 литра воды в день, чтобы поддерживать оптимальный водный баланс. Регулярное употребление воды улучшает обмен веществ, способствует выведению токсинов и поддерживает здоровье кожи, что особенно важно при регулярных тренировках.",
    "Вы сегодня выполнили все упражнения, приходите завтра! Добавьте больше белка в рацион для роста мышц и ускоренного восстановления. Белок помогает восстанавливать мышечные волокна после нагрузок, улучшает общий тонус и способствует росту силы, особенно в сочетании с регулярными силовыми тренировками.",
    "Вы сегодня выполнили все упражнения, приходите завтра! Сон не менее 7-8 часов – залог хорошего восстановления и эффективных тренировок. Качественный сон способствует снижению уровня стресса, поддерживает гормональный баланс и помогает организму восстанавливаться после интенсивных занятий.",
    "Вы сегодня выполнили все упражнения, приходите завтра! Сделайте кардио 3-4 раза в неделю для улучшения выносливости и сжигания жира. Регулярное кардио тренировки способствуют укреплению сердечно-сосудистой системы, повышают выносливость и помогают контролировать вес, что важно для достижения рельефа.",
    "Вы сегодня выполнили все упражнения, приходите завтра! Ешьте овощи и фрукты, которые являются источником витаминов, минералов и антиоксидантов. Включение свежих овощей и фруктов в рацион улучшает пищеварение, поддерживает иммунитет и способствует быстрому восстановлению после тренировок.",
    "Вы сегодня выполнили все упражнения, приходите завтра! Включите в тренировки силовые упражнения для улучшения рельефа и формирования подтянутой фигуры. Силовые нагрузки помогают укреплять мышцы, ускоряют обмен веществ и делают тело более плотным, особенно при правильном сочетании с кардио и растяжкой.",
    "Вы сегодня выполнили все упражнения, приходите завтра! Следите за техникой выполнения упражнений, чтобы избежать травм и достичь максимальной эффективности. Используйте зеркало или обратную связь от тренера, чтобы убедиться в правильности движений, так как корректная техника – основа успешной тренировки.",
    "Вы сегодня выполнили все упражнения, приходите завтра! Разнообразьте свои тренировки, чтобы задействовать разные группы мышц и предотвратить адаптацию организма. Меняйте упражнения, схемы и интенсивность, чтобы постоянно стимулировать рост и улучшение физической формы.",
    "Вы сегодня выполнили все упражнения, приходите завтра! Регулярно делайте разминку перед тренировкой и заминку после неё. Разминка подготавливает мышцы и суставы к нагрузкам, а заминка помогает предотвратить мышечные спазмы и ускоряет восстановление после интенсивных занятий.",
    "Вы сегодня выполнили все упражнения, приходите завтра! Следите за своим питанием и режимом отдыха. Сбалансированная диета, включающая достаточное количество белков, жиров и углеводов, в сочетании с качественным сном и отдыхом, является ключом к достижению ваших фитнес-целей."
];
...
function showAdvice() {
    ...
    // Отображаем случайный совет
    adviceContainer.textContent = randomAdvice;

    // Показываем слой overlay и рекламный блок
    const overlay = document.getElementById("overlay");
    const adBanner = document.getElementById("ad-banner");

    // Показываем overlay и рекламный блок
    overlay.style.display = "flex";
    adBanner.style.display = "block";
}

// Функция для скрытия рекламного блока
